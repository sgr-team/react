...
import { UpflowAdapter, UpflowOptions } from "@sgrnext/api-upflow";

export const createAdapter = async (options: UpflowOptions = { }): Promise<UpflowAdapter> => {
  ...
  const result: UpflowAdapter = await factory.createAdapter();
